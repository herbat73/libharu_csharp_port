...
public static class DocumentFeatures
{
    public static void Test(string repoRoot, string pdfPath)
    {
        ...
        HPDF_SetViewerPreference(pdf, PdfViewerPreference.HideToolbar | PdfViewerPreference.FitWindow | PdfViewerPreference.PrintScalingNone);
        ...
        HPDF_Annot_SetAppearance(widget, PdfAnnotationAppearanceState.Normal, "0.8 0.9 1 rg 0 0 60 30 re f", new PdfRect(0, 0, 60, 30), "Yes");
        HPDF_Annot_SetAppearance(widget, PdfAnnotationAppearanceState.Rollover, "0.9 1 0.9 rg 0 0 60 30 re f", new PdfRect(0, 0, 60, 30), "Yes");
        HPDF_Annot_SetAppearance(widget, PdfAnnotationAppearanceState.Down, "0.7 0.8 1 rg 0 0 60 30 re f", new PdfRect(0, 0, 60, 30), "Yes");
        ...
        var shading = HPDF_Shading_New(pdf, PdfShadingType.FreeFormTriangleMesh, PdfColorSpace.DeviceRgb, 0, 200, 0, 200);
        ...
        HPDF_Shading_AddVertexRGB(shading, PdfShadingFreeFormTriangleMeshEdgeFlag.ConnectPreviousSecond, 100, 180, 0, 0, 255);
        HPDF_Page_SetShading(page, shading);
        HPDF_Page_SetShading(page, HPDF_Shading_NewAxial(pdf, new PdfPoint(45, 555), new PdfPoint(220, 555), new PdfRgbColor(1, 0, 0), new PdfRgbColor(0, 0, 1), true, true));
        HPDF_Page_SetShading(page, HPDF_Shading_NewRadial(pdf, new PdfPoint(325, 555), 5, new PdfPoint(385, 555), 65, new PdfRgbColor(1, 1, 0), new PdfRgbColor(0, 0.5, 0.8), false, true));
        ...
        HPDF_3DView_SetCameraByMatrix(orthographicView, new Pdf3DMatrix(1, 0, 0, 0, 0.5, 0.866, 0, -0.866, 0.5, 12, 24, 36), 48);
        ...
        var projection = HPDF_Page_CreateProjectionAnnot(page, new PdfRect(330, 545, 520, 570), "Projection annotation");
        ...
        Require(latin1.Contains("/Subtype /O", StringComparison.Ordinal), "Missing orthographic projection dictionary.");
        ...
        Require(latin1.Contains("/ShadingType 4", StringComparison.Ordinal), "Missing free-form triangle mesh shading.");
