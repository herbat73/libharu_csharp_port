...
internal static class PredefinedCidFonts
{
    ...
    private static readonly Dictionary<string, (string Ordering, int Supplement)> SupportedNames =
    ...
    {
        return SupportedNames.ContainsKey(name);
    }
    ...
    private static CidFamilyMetrics MetricsForFamily(string family)
    {
        return family switch
        {
            "MS-Gothic" => new CidFamilyMetrics(new PdfRect(0, -136, 1000, 859), 859, -140, 769,
                FontSymbolic | FontFixedWidth, 0, 78),
            "MS-PGothic" => new CidFamilyMetrics(new PdfRect(-121, -136, 996, 859), 859, -140, 679, FontSymbolic, 0,
                78),
            "MS-Mincho" => new CidFamilyMetrics(new PdfRect(0, -136, 1000, 859), 859, -140, 769,
                FontSymbolic | FontFixedWidth | FontSerif, 0, 78),
            "MS-PMincho" => new CidFamilyMetrics(new PdfRect(-82, -136, 996, 859), 859, -140, 679,
                FontSymbolic | FontSerif, 0, 78),
            "DotumChe" => new CidFamilyMetrics(new PdfRect(0, -150, 1000, 863), 858, -141, 679,
                FontSymbolic | FontFixedWidth, 0, 78),
            "Dotum" => new CidFamilyMetrics(new PdfRect(0, -150, 1000, 863), 858, -141, 679, FontSymbolic, 0, 78),
            "BatangChe" => new CidFamilyMetrics(new PdfRect(0, -154, 1000, 861), 858, -141, 769,
                FontSymbolic | FontFixedWidth | FontSerif, 0, 78),
            "Batang" => new CidFamilyMetrics(new PdfRect(0, -154, 1000, 861), 858, -141, 679, FontSymbolic | FontSerif,
                0, 78),
            "SimSun" => new CidFamilyMetrics(new PdfRect(0, -140, 996, 855), 859, -140, 683,
                FontSymbolic | FontFixedWidth | FontSerif, 0, 78),
            "SimHei" => new CidFamilyMetrics(new PdfRect(0, -140, 996, 855), 859, -140, 769,
                FontSymbolic | FontFixedWidth, 0, 78),
            "MingLiU" => new CidFamilyMetrics(new PdfRect(0, -199, 1000, 800), 800, -199, 769,
                FontSymbolic | FontFixedWidth | FontSerif, 0, 78),
            _ => new CidFamilyMetrics(new PdfRect(0, -136, 1000, 859), 859, -140, 769, FontSymbolic, 0, 78)
        };
    }

    private sealed record CidFamilyMetrics(
        PdfRect BBox,
        int Ascent,
        int Descent,
        int CapHeight,
